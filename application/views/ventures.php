...
<html lang="en">
	...
	<body class="no-trans">
		...
		<div class="page-wrapper">
			...
			<section class="offcanvas-container">
				<nav id="offcanvas" class="animated navmenu navmenu-default navmenu-fixed-left offcanvas offcanvas-left" role="navigation">
					...
					<ul class="nav navbar-nav text-center">
						<li><a href="/">Home</a></li>
						<li class="active"><a href="/ventures">Ventures</a></li>
						<li class="dropdown">
							<a href="/Main/teams" class="dropdown-toggle" data-toggle="dropdown">Teams</a>
							<ul class="dropdown-menu">
								<li><a href="/teams">2016/2017</a></li>
							...
							<div class="row">
								<div class="col-md-8 col-md-offset-2">
									<div class="footer-content text-center padding-ver-clear">
										...
										<h1 class="title_teams_page page-title">Ventures</h1>
									</div>
								</div>
							</div>
						</div>
			...
			<input type="image" src="/assets/images/ventures_logos/urbanrotterdamlogo.png" class="btn btn-lg btn-default" data-toggle="modal" data-target="#venture_one" style="height: 350px; width: 350px"/>
			...
			<!-- ============================================================================== -->
			<!-- Button trigger modal -->
			<input type="image" src="/assets/images/ventures_logos/buurt.jpg" class="btn btn-lg btn-default" data-toggle="modal" data-target="#venture_two" style="height: 350px; width: 350px"/>
			...
			<!-- ============================================================================== -->
			<!-- Button trigger modal -->
			<input type="image" src="/assets/images/ventures_logos/klik.png" class="btn btn-lg btn-default" data-toggle="modal" data-target="#venture_three" style="height: 350px; width: 350px"/>
			...
			<!-- ============================================================================== -->
			<!-- Button trigger modal -->
			<input type="image" src="/assets/images/ventures_logos/organobike.jpg" class="btn btn-lg btn-default" data-toggle="modal" data-target="#venture_four" style="height: 350px; width: 350px"/>
			...
			<!-- ============================================================================== -->
			<!-- Button trigger modal -->
			<input type="image" src="/assets/images/ventures_logos/smaak.png" class="btn btn-lg btn-default" data-toggle="modal" data-target="#venture_five" style="height: 350px; width: 350px"/>
			...
			<!-- ============================================================================== -->
			<!-- Button trigger modal -->
			<input type="image" src="/assets/images/ventures_logos/whw.jpg" class="btn btn-lg btn-default" data-toggle="modal" data-target="#venture_six" style="height: 350px; width: 350px"/>
