        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-10">
                        <div class="panel panel-default">
                            <div class="panel-heading">Below are all the teammember applications registered in your database so far.</div>
                            <table class="table table-hover table-condensed">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form class="form-inline mg-0" action="/Admin_edit/teammember_applications_update/<?php echo $application['id']; ?>" method="POST">
                                    ...
                                    <td>
                                        <form class="form-inline mg-0" action="/Admin_edit/teammember_applications_delete/<?php echo $application['id']; ?>" method="POST">
                        ...
                        <form class="form" action="/Admin/teammember_applications_export" method="POST">
